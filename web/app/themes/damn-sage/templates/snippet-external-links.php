...
<?php if(get_field('external_links')): ?>
  <div class="borderedBox">
    ...
    <?php while(has_sub_field('external_links')): ?>
      <span><i class="fa fa-external-link"></i> &nbsp; <a href="<?php the_sub_field('external_urls'); ?>" target="_blank" title="More Information"><?php the_sub_field('external_urls'); ?></a><br /></span>
    <?php endwhile; ?>
  </div>
<?php endif; ?>