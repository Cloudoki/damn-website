...
<div class="item col-xs-12 col-sm-12 slider-content <?=has_post_format('quote')? 'quote-format ':null?><?=implode (' ', $cats)?>"<?=isset ($url)? ' style="width:100%!important;height:89%!important;background-image:url(' . $url . ');"': null?>>
